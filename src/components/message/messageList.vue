      ...
      <div class="message-container">
        <div class="message">
          ...
          <div class="message-content" :class="{ 'message-content-myself': myId == item.fromUid }">
            ...
            <template v-else>
              <div v-if="isImage(item.msg.fileExtension)"><img class="image-file" @click="viewImage(getFileUrl(item.filePath, item.fileName, item.fileMimeType), item.imageWidth, item.imageHeight)" :width="item.imageThumbWidth" :height="item.imageThumbHeight" :src="getFileUrl(item.filePath + '/thumb', item.fileName, item.fileMimeType)"></div>
              <div v-else-if="isGif(item.msg.fileExtension)"><img class="image-file" @click="viewImage(getFileUrl(item.filePath, item.fileName, item.fileMimeType), item.imageWidth, item.imageHeight)" :width="item.imageWidth" :height="item.imageHeight" :src="getFileUrl(item.filePath, item.fileName, item.fileMimeType)"></div>
